...
export default function BedrijfsInfoScreen() {
    return (
...
<View style={styles.bgview}>
        ...
        <Text style={styles.textlogin}>Bedrijfsinfo</Text>
        </View> 
...
<Text style={styles.textgevonden}>Wordt door duizenden klanten gevonden!</Text>
</View>
